window.addEventListener('load', function(){
    ...
    function displayStatusText(context) {
        ...
        if(gameOver){
            ...
            context.fillText('Game Over looser :) press enter or swipe down to restar !' , canvas.width*0.5, 200);
            context.fillStyle = 'black';
            context.fillText('Game Over looser :) press enter or swipe down to restar !' , canvas.width*0.5 +2, 202);
